...
int main( int argc, char * argv[] )
{
	...
	for ( i = 0; i < NTHREADS; i++ )
	{
		...
		if ( ret != 0 )
		{
                        printf("pthread_create failed, returned %d, i: %d\n", ret, i);
	...
	for ( i = 0; i < NTHREADS; i++ )
	{
		...
		if ( ret != 0 )
		{
                        printf("pthread_join failed, returned %d, i: %d\n", ret, i);
	...
	if ( ret != 0 )
	{
                printf("pthread_mutex_lock failed, returned %d\n", ret);
		UNRESOLVED( ret, "Failed to lock mutex in initializer" );
	}
	...
	if ( ret != 0 )
	{
                printf("pthread_mutex_unlock failed, returned %d\n", ret);
		UNRESOLVED( ret, "Failed to unlock mutex in initializer" );
	}
