...
#if 1	/* XXX -gl */
#undef IRQ_TIMERINT0_1
#define IRQ_TIMERINT0_1 5
extern unsigned long TIMER_BASE;
#define TIMER0_VA_BASE		TIMER_BASE
#define TIMER3_VA_BASE		(TIMER_BASE + 0x20)
...
#endif
{
	 ...
	 */
#if 0	/* XXX: assume kernel already done this for us -gl */
	 ...
	 */
#if 0	/* XXX don't touch all timers, kernel needs them -gl */
