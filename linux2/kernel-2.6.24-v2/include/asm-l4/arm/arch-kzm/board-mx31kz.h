...
#ifndef __ASM_ARM_ARCH_BOARD_MX31KZ_H_
#define __ASM_ARM_ARCH_BOARD_MX31KZ_H_
...
#if defined(CONFIG_KZM_UART2_IRDA)
...
#if defined(CONFIG_KZM_UART3_IRDA)
...
#define KZCTL_BASE_ADDRESS        IO_ADDRESS(CS4_BASE_ADDR)
/* LCD POWER */
#define KZCTL_1                   0x1000
#define KZCTL_2                   0x1001
#define KZCTL_RSW                 0x1002
#define KZCTL_LIGHT               0x1004
#define KZCTL_FPGA_REV            0x1008
#define KZCTL_7SEG_LED            0x1010
#define KZCTL_LED                 0x1020
#define KZCTL_DIPSW2              0x1003

/*!
 * External UART A. for touch panel. UART B. KDDI
 */
#define PBC_SC16550_A           0x00001050		// touch panel
#define PBC_SC16550_B           0x00001040		// KDDI
...
#define EXPIO_PARENT_INT	IOMUX_TO_IRQ(MX31_PIN_GPIO1_0)
...
#endif				/* __ASM_ARM_ARCH_BOARD_MX31KZ_H_ */
